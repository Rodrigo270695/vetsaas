...
return [
    ...
    'ventas' => [
        ...
        'validation' => [
            ...
            'pagos_requeridos' => 'Add at least one payment method.',
            'pago_metodo_duplicado' => 'Do not repeat the same payment method.',
            'pago_monto_invalido' => 'Each payment must be greater than zero.',
            'pagos_no_cuadran' => 'Payments sum (:suma) does not match the total (:total).',
