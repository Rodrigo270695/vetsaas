...
return [
    'grooming' => [
        ...
        'categoria_created' => 'Categoría de grooming creada.',
        ...
        'missing_categorias_table' => 'Falta la tabla de categorías de grooming. Ejecuta las migraciones del tenant (t113).',
    ...
    'hotel' => [
        ...
        'categoria_created' => 'Categoría de hotel creada.',
        ...
        'missing_categorias_table' => 'Falta la tabla de categorías de hotel. Ejecuta las migraciones del tenant (t113).',
