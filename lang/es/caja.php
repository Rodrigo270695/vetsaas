...
return [
    ...
    'ventas' => [
        ...
        'validation' => [
            ...
            'pagos_requeridos' => 'Indica al menos un método de pago.',
            'pago_metodo_duplicado' => 'No repitas el mismo método de pago.',
            'pago_monto_invalido' => 'Cada pago debe tener un monto mayor a cero.',
            'pagos_no_cuadran' => 'La suma de pagos (:suma) no coincide con el total (:total).',
        ...
        'anulacion' => [
            ...
            'fel_no_configurado' => 'No se puede anular el comprobante SUNAT: revisa Lucode (APISUNAT) y el plan de facturación electrónica.',
