...
export function KnowledgeDeleteDialog({
    ...
    const onConfirm = () => {
        if (!entry) return;
        setProcessing(true);
        router.delete(salesbotKnowledge.destroy(entry.id).url, {
            preserveScroll: true,
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogTitle className="pt-2 text-base">
                        {t('salesbot-knowledge:delete.title')}
                    </DialogTitle>
                    <DialogDescription className="text-sm text-muted-foreground">
                        <Trans
                            i18nKey="salesbot-knowledge:delete.description"
                ...
                <DialogFooter className="flex-col-reverse gap-2 sm:flex-row sm:justify-end">
                    ...
                    >
                        {t('salesbot-knowledge:delete.cancel')}
                    </Button>
                    <Button
                        type="button"
                        variant="destructive"
                    ...
                    >
                        ...
                        {t('salesbot-knowledge:delete.confirm')}
                    </Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
