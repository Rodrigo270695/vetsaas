...
export type InternamientoDeleteDialogProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    internamiento: InternamientoRow | null;
};

export function InternamientoDeleteDialog({
    open,
    onOpenChange,
    internamiento,
}: InternamientoDeleteDialogProps) {
    ...
    const onConfirm = () => {
        ...
        setProcessing(true);
        router.delete(`/clinica/hospitalizacion/${internamiento.id}`, {
            preserveScroll: true,
