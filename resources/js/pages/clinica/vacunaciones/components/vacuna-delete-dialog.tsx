...
export type VacunaDeleteDialogProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    vacuna: VacunaAplicadaRow | null;
};

export function VacunaDeleteDialog({ open, onOpenChange, vacuna }: VacunaDeleteDialogProps) {
    ...
    const onConfirm = () => {
        ...
        setProcessing(true);
        router.delete(clinica.vacunaciones.destroy({ vacuna_aplicada: vacuna.id }).url, {
            preserveScroll: true,
