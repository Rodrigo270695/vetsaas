...
export type PedidoDeleteDialogProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    pedido: PedidoLaboratorioRow | null;
};

export function PedidoDeleteDialog({ open, onOpenChange, pedido }: PedidoDeleteDialogProps) {
    ...
    const onConfirm = () => {
        ...
        setProcessing(true);
        router.delete(clinica.laboratorio.destroy({ pedido_laboratorio: pedido.id }).url, {
            preserveScroll: true,
