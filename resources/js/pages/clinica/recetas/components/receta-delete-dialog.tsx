...
export type RecetaDeleteDialogProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    receta: RecetaRow | null;
};

export function RecetaDeleteDialog({ open, onOpenChange, receta }: RecetaDeleteDialogProps) {
    ...
    const onConfirm = () => {
        ...
        setProcessing(true);
        router.delete(clinica.recetas.destroy({ receta: receta.id }).url, {
            preserveScroll: true,
