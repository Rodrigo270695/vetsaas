...
export type PropietarioDeleteDialogProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    propietario: Propietario | null;
};

export function PropietarioDeleteDialog({
    open,
    onOpenChange,
    propietario,
}: PropietarioDeleteDialogProps) {
    ...
    const onConfirm = () => {
        ...
        setProcessing(true);
        router.delete(propietarios.destroy(propietario.id).url, {
            preserveScroll: true,
