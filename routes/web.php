...
Route::middleware(['auth', 'verified', 'tenant.match-user', 'force-password-change'])->group(function () {
    ...
    */
    ...
    Route::prefix('caja')->name('caja.')->group(function () {
        ...
        Route::middleware('permission:ventas.create')
            ->get('ventas/desde-cargos', [VentaController::class, 'createDesdeCargos'])
            ->name('ventas.create-desde-cargos');
    ...
    Route::prefix('facturacion')->name('facturacion.')->group(function () {
        ...
        Route::middleware('permission:documentos.create')
            ...
            ->whereUuid('felDocument')
            ->name('documentos.pasar-a-produccion');
    ...
    */
    Route::prefix('plataforma')->name('plataforma.')->group(function () {
        ...
        Route::middleware('permission:plataforma-suscripciones.update')
            ->post('suscripciones/{suscripcion}/win-back/generate', [SubscriptionController::class, 'generateWinBackMessage'])
            ->name('suscripciones.win-back.generate');
        Route::middleware('permission:plataforma-suscripciones.update')
            ->post('suscripciones/{suscripcion}/win-back/send', [SubscriptionController::class, 'sendWinBackWhatsApp'])
            ->name('suscripciones.win-back.send');
