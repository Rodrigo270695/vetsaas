    ...
    Route::middleware(['auth', 'verified', 'tenant.match-user', 'force-password-change'])->group(function () {
        ...
        */
        ...
        Route::prefix('configuracion')->name('configuracion.')->group(function () {
            ...
            Route::middleware('permission:tarifas.view')
                ->get('tarifas', [\App\Http\Controllers\TarifaServiciosController::class, 'index'])
                ->name('tarifas.index');
            Route::middleware('permission:tarifas.create')
                ->post('tarifas/grooming', [\App\Http\Controllers\TarifaServiciosController::class, 'storeGrooming'])
                ->name('tarifas.grooming.store');
            Route::middleware('permission:tarifas.update')
                ->put('tarifas/grooming/{grooming_tarifa}', [\App\Http\Controllers\TarifaServiciosController::class, 'updateGrooming'])
                ->whereUuid('grooming_tarifa')
                ->name('tarifas.grooming.update');
            Route::middleware('permission:tarifas.delete')
                ->delete('tarifas/grooming/{grooming_tarifa}', [\App\Http\Controllers\TarifaServiciosController::class, 'destroyGrooming'])
                ->whereUuid('grooming_tarifa')
                ->name('tarifas.grooming.destroy');
            Route::middleware('permission:tarifas.create')
                ->post('tarifas/hotel', [\App\Http\Controllers\TarifaServiciosController::class, 'storeHotel'])
                ->name('tarifas.hotel.store');
            Route::middleware('permission:tarifas.update')
                ->put('tarifas/hotel/{hotel_tarifa}', [\App\Http\Controllers\TarifaServiciosController::class, 'updateHotel'])
        ...
        */
        Route::prefix('plataforma')->name('plataforma.')->group(function () {
            ...
            Route::middleware('permission:plataforma-tenants.view')
                ->get('auditoria-soporte', [\App\Http\Controllers\PlataformaImpersonationAuditController::class, 'index'])
