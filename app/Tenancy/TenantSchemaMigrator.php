...
class TenantSchemaMigrator
{
    ...
    private function tenantMigrationIsMaterialized(string $migration): bool
    {
        return match ($migration) {
            ...
            '2026_09_10_110000_t147_sala_espera_enviado' => Schema::hasTable('citas')
                && Schema::hasColumn('citas', 'sala_espera_enviado_at')
                && Schema::hasTable('grooming_turnos')
                && Schema::hasColumn('grooming_turnos', 'sala_espera_enviado_at'),
            '2026_09_13_120000_t148_sala_espera_numero' => Schema::hasTable('citas')
            ...
            '2026_08_24_190000_t136_modo_asesora_clinicas_asesoradas' => Schema::hasTable('cfg_clinic_settings')
                ...
                && Schema::hasTable('clinicas_asesoradas')
