...
class UpdateInternamientoRequest extends FormRequest
{
    ...
    public function withValidator(\Illuminate\Validation\Validator $validator): void
    {
        $validator->after(function (\Illuminate\Validation\Validator $v): void {
            ...
            if ($this->input('estado') === Internamiento::ESTADO_ALTA && $this->input('alta_at') === null) {
                $v->errors()->add('alta_at', __('hospitalizacion.validation.alta_at_requerida'));
            }
        });
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'estado' => ['required', 'string', Rule::in(Internamiento::ESTADOS)],
