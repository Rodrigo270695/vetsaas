...
class ClinicSettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'recordatorio_agenda_servicios_dias_antes_opciones' => ['required', 'array'],
            'recordatorio_agenda_servicios_dias_antes_opciones.*' => [
                'integer',
                'distinct',
                Rule::in(ClinicSetting::APPOINTMENT_REMINDER_DAY_OPTIONS),
            ],
            'recordatorio_agenda_servicios_2h_activo' => ['required', 'boolean'],
            ...
            'notificar_hotel_creado_whatsapp_activo' => ['required', 'boolean'],
            'notificar_hotel_confirmado_whatsapp_activo' => ['required', 'boolean'],
            'notificar_hotel_en_estancia_whatsapp_activo' => ['required', 'boolean'],
            'notificar_hotel_completado_whatsapp_activo' => ['required', 'boolean'],
            'notificar_hotel_cancelado_whatsapp_activo' => ['required', 'boolean'],
    ...
    public function attributes(): array
    {
        return [
            ...
            'recordatorio_agenda_servicios_dias_antes_opciones' => 'momentos de recordatorio de agenda de servicios',
            'recordatorio_agenda_servicios_dias_antes_opciones.*' => 'momento de recordatorio de agenda de servicios',
            'recordatorio_agenda_servicios_2h_activo' => 'recordatorio 2 h de agenda de servicios',
            ...
            'notificar_hotel_creado_whatsapp_activo' => 'notificación al crear una estancia',
            'notificar_hotel_confirmado_whatsapp_activo' => 'notificación de estancia confirmada',
            'notificar_hotel_en_estancia_whatsapp_activo' => 'notificación de ingreso al hotel',
            'notificar_hotel_completado_whatsapp_activo' => 'notificación de estancia completada',
            'notificar_hotel_cancelado_whatsapp_activo' => 'notificación de estancia cancelada',
            'notificar_hotel_no_presento_whatsapp_activo' => 'notificación de inasistencia al hotel',
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'recordatorio_agenda_servicios_2h_activo' => $this->boolean('recordatorio_agenda_servicios_2h_activo'),
            ...
            'notificar_hotel_creado_whatsapp_activo' => $this->boolean('notificar_hotel_creado_whatsapp_activo'),
            'notificar_hotel_confirmado_whatsapp_activo' => $this->boolean('notificar_hotel_confirmado_whatsapp_activo'),
            'notificar_hotel_en_estancia_whatsapp_activo' => $this->boolean('notificar_hotel_en_estancia_whatsapp_activo'),
            'notificar_hotel_completado_whatsapp_activo' => $this->boolean('notificar_hotel_completado_whatsapp_activo'),
            'notificar_hotel_cancelado_whatsapp_activo' => $this->boolean('notificar_hotel_cancelado_whatsapp_activo'),
            'notificar_hotel_no_presento_whatsapp_activo' => $this->boolean('notificar_hotel_no_presento_whatsapp_activo'),
