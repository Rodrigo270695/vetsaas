...
class ClinicSettingController extends Controller
{
    ...
    public function update(ClinicSettingRequest $request, TenantManager $tenants): RedirectResponse
    {
        ...
        $setting->fill([
            ...
            'recordatorio_agenda_servicios_dias_antes_opciones' => $data['recordatorio_agenda_servicios_dias_antes_opciones'],
            'recordatorio_agenda_servicios_2h_activo' => $data['recordatorio_agenda_servicios_2h_activo'],
            ...
            'notificar_hotel_creado_whatsapp_activo' => $data['notificar_hotel_creado_whatsapp_activo'],
            'notificar_hotel_confirmado_whatsapp_activo' => $data['notificar_hotel_confirmado_whatsapp_activo'],
            'notificar_hotel_en_estancia_whatsapp_activo' => $data['notificar_hotel_en_estancia_whatsapp_activo'],
            'notificar_hotel_completado_whatsapp_activo' => $data['notificar_hotel_completado_whatsapp_activo'],
            'notificar_hotel_cancelado_whatsapp_activo' => $data['notificar_hotel_cancelado_whatsapp_activo'],
    ...
    private function presentSetting(ClinicSetting $setting, bool $planPermiteFacturaElectronica): array
    {
        return [
            ...
            'recordatorio_agenda_servicios_dias_antes_opciones' => $setting->recordatorioAgendaServiciosDiasAntesOpciones(),
            'recordatorio_agenda_servicios_2h_activo' => (bool) ($setting->recordatorio_agenda_servicios_2h_activo ?? true),
            ...
            'notificar_hotel_creado_whatsapp_activo' => $setting->notificarHotelWhatsAppActivo('programada'),
            'notificar_hotel_confirmado_whatsapp_activo' => $setting->notificarHotelWhatsAppActivo('confirmada'),
            'notificar_hotel_en_estancia_whatsapp_activo' => $setting->notificarHotelWhatsAppActivo('en_estancia'),
            'notificar_hotel_completado_whatsapp_activo' => $setting->notificarHotelWhatsAppActivo('completada'),
            'notificar_hotel_cancelado_whatsapp_activo' => $setting->notificarHotelWhatsAppActivo('cancelada'),
            'notificar_hotel_no_presento_whatsapp_activo' => $setting->notificarHotelWhatsAppActivo('no_presento'),
