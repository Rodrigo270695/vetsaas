...
it('poda backups locales y remotos fuera de la retención de 14 días', function (): void {
    ...
    $disk->put('vetsaas/db/2026-08-20_020000/full.dump', 'keep');
    $disk->put('vetsaas/db/2026-07-12_020008/full.dump', 'drop');
    ...
    expect($result['local_deleted'])->toBe(1)
        ...
        ->and($disk->exists('vetsaas/db/2026-08-20_020000/full.dump'))->toBeTrue()
        ->and($disk->exists('vetsaas/db/2026-07-12_020008/full.dump'))->toBeFalse()
